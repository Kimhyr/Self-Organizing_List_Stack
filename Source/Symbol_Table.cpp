...
// template<std::equality_comparable Key_T, typename Value_T>
// void Symbol_Table<Key_T, Value_T>::enter(Symbol& entry, Symbol* parent) {
// 	if (!parent) {
// 		this->root_ = &entry;
// 		return;
// 	}
...
// access_from(Key_Type const& key, Symbol const& parent) -> Value_Type& {
...
// template<std::equality_comparable Key_T, typename Value_T>
// Symbol_Table<Key_T, Value_T>::Symbol::~Symbol() noexcept {
// 	this->detach();
...
// template<std::equality_comparable Key_T, typename Value_T>
// void Symbol_Table<Key_T, Value_T>::Symbol::nullify_biases() noexcept {
// 	for (Symbol* curr = this->child_; curr; curr = curr->next_)
// 		curr->bias_ = 0;
// }

// template<std::equality_comparable Key_T, typename Value_T>
// void Symbol_Table<Key_T, Value_T>::Symbol::detach() noexcept {
	// if (this->prior())
...
// template<std::equality_comparable Key_T, typename Value_T>
// void Symbol_Table<Key_T, Value_T>::Symbol::prepend(Symbol& other) noexcept {
...
// template<std::equality_comparable Key_T, typename Value_T>
// void Symbol_Table<Key_T, Value_T>::Symbol::append(Symbol& other) noexcept {
// 	other.prior_ = this;
...
// template<std::equality_comparable Key_T, typename Value_T>
// void Symbol_Table<Key_T, Value_T>::Symbol::increase_bias() noexcept {
	// ++this->bias_;
